document.addEventListener('DOMContentLoaded', function () {
    ...
    const PRODUCTS = [
      { id: 'p1', name: 'Midnight Oud', price: 125.00, desc: 'Warm oud with amber & vanilla.', image: null },
      { id: 'p2', name: 'Citrus Bloom', price: 78.50, desc: 'Fresh citrus & floral top notes.', image: null },
      { id: 'p3', name: 'Velvet Rose', price: 95.00, desc: 'Classic rose with musk.', image: null },
      { id: 'p4', name: 'Ocean Mist', price: 65.00, desc: 'Cool aquatic scent for day use.', image: null },
      { id: 'p5', name: 'Amber Spice', price: 150.00, desc: 'Rich amber, spice & wood.', image: null },
      { id: 'p6', name: 'Vanilla Sky', price: 45.00, desc: 'Sweet gourmand vanilla.', image: null }
    ];

    // create small SVG placeholder image data URLs
    function bottleSVG(name){
      const svg = `<svg xmlns='http://www.w3.org/2000/svg' width='300' height='200' viewBox='0 0 300 200'>
        <rect width='300' height='200' rx='12' fill='none'/>
        <g transform='translate(50,20)'>
          <rect x='40' y='10' width='80' height='120' rx='12' fill='%23ffffff10' stroke='%23ffffff22' />
          <rect x='58' y='-6' width='40' height='18' rx='4' fill='%23ffffff22' />
        </g>
        <text x='150' y='170' font-size='16' fill='%23ffffff66' text-anchor='middle' font-family='Arial'>${escapeHtml(name)}</text>
      </svg>`;
      return 'data:image/svg+xml;utf8,' + encodeURIComponent(svg);
    }
    PRODUCTS.forEach(p => p.image = bottleSVG(p.name));
